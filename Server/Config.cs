...
namespace Server
{
    class Config
    {
        ...
        public static string DBConfig = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\Projects\TradeBot\ServerCopy\Server\Trading.mdf;Integrated Security=True";
